...
const page = () => {
  ...
  return (
    <>
      <Meta
        title="Edu.trade Introducing Brokers Growth Event 11th October 2025"
        description="Join Edu.trade at The Museum of the Future and discover how GCC Introducing Brokers can scale their business with exclusive events, insights, and opportunities."
      />
