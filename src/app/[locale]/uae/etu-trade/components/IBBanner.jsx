...
export default function IbCtaBanner({
    ...
    return (
        <section className="relative w-full overflow-hidden min-h-[390px] flex items-center">
            ...
            />
            {/* Content */}
            <div className="mx-auto container relative py-10 md:py-12">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
                    {/* LEFT: Heading */}
                    <div className="">
                        <h2 className="text-white font-semibold leading-[1.15] text-[40px]">
                    ...
                    {/* RIGHT: Copy + CTA */}
                    <div className="">
                        <p className="text-white leading-[32px text-[22px]">
